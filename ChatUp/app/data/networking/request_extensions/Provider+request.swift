...
extension Provider {
    ...
    func requestE(_ target: API, completion: @escaping (ApiError?) -> Void) {
        
    }
    
    func request<D: Decodable>(_ target: API, decoder: JSONDecoder = JSONDecoder.snakeCaseDecoder, completion: @escaping RequestCompletion<D>) {
